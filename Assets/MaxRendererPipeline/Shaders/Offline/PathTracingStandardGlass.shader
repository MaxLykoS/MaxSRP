Shader "MaxSRP/PathTracingGlass"
{
	Properties
	{
	...
	SubShader
	{
		Pass
		{
			...
			#include "../../ShaderLibrary/Offline/RayPayload.hlsl"
			#include "../../ShaderLibrary/Offline/Utils.hlsl"
			#include "../../ShaderLibrary/Offline/GlobalResources.hlsl"
			...
			{
				if (payload.bounceIndexTransparent == _BounceCountTransparent)
				{
